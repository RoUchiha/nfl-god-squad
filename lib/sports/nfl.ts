...
const HISTORICAL_ROSTERS: Record<string, HistoricalPlayer[]> = {
  // Steel Curtain Steelers 1974-1979
  '23-nfl-steel': [
  ...
  // Belichick Dynasty I (Patriots 2001-2008)
  '17-nfl-pats-early': [
  ...
  // Belichick Dynasty II (Patriots 2009-2018)
  '17-nfl-pats-late': [
